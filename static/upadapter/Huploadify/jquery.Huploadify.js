...
$.fn.Huploadify = function(opts){
	...
	this.each(function(){
		...
		inputStr += '"/>';
		inputStr += '<a id="file_upload_'+instanceNumber+'-button" href="javascript:void(0)" class="uploadifyclass btn btn-success">';
	  ...
	  var fileObj = {
		  ...
		  init: function() {	  
			  ...
			  _this.find('.uploadifyclass').on('click',function(){
